...
static int ParseStringChunk(PARSER *ap) {
    ...
    ap->string_chunk->string_poll_len =
            (ap->string_chunk->style_poll_offset ? ap->string_chunk->style_poll_offset : ap->string_chunk->chunk_size) -
            ap->string_chunk->string_poll_offset;
